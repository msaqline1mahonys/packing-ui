            ...
            >
              <div className="mb-1 flex items-start justify-between gap-2">
                ...
                <span className="text-[11px] font-semibold text-slate-500">
                  {charge.chargeType || "-"} Â· {getClassLabel(charge)}
                </span>
              </div>
              ...
              <div className="text-xs font-semibold text-slate-800">
                ...
                {charge.accountCode ? ` Â· ${charge.accountCode}` : ""}
              </div>
            </div>
          );
        })
                  ...
                  {filtered.length === 0 ? (
                    ...
                    filtered.map((charge) => {
                      ...
                      return (
                        ...
                        >
                          <td className="px-3 py-2.5 text-slate-700">{charge.chargeName || "â€”"}</td>
                          <td className="px-3 py-2.5 text-slate-700">
                            {(charge.chargeDescription || "-").slice(0, 40)}
                            {(charge.chargeDescription || "").length > 40 ? "..." : ""}
                          </td>
                          <td className="px-3 py-2.5 text-slate-700">{charge.chargeRate != null ? Number(charge.chargeRate) : "â€”"}</td>
                          <td className="px-3 py-2.5 text-slate-700">{charge.chargeType || "â€”"}</td>
                          <td className="px-3 py-2.5 text-slate-700">{getClassLabel(charge)}</td>
                          <td className="px-3 py-2.5 text-slate-700">{charge.accountCode || "â€”"}</td>
