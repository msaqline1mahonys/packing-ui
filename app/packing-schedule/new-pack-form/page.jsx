...
const topRowSectionsClass = (showImportBulkSection) =>
  cn(
    sectionRowClass,
    showImportBulkSection ? "lg:grid-cols-[minmax(0,1fr)_minmax(0,14rem)]" : "",
  );
const packBasicsGridClass = "grid grid-cols-1 gap-x-2.5 gap-y-1.5 sm:grid-cols-3";
...
const containersShippingRowClass = cn(sectionRowClass, "items-stretch xl:grid-cols-2");
          ...
          <>
            <div className={topRowSectionsClass(showImportBulkSection)}>
              <section className={flushSectionClass} aria-label="Pack basics">
                <div className={cn(flushSectionBodyClass, packBasicsGridClass)}>
            ...
            <section
              className={cn(sectionClass, isImportJob && "bg-emerald-50/60")}
            ...
            >
              ...
              {selectedVessel ? (
                <p className="mt-1.5 shrink-0 text-[10px] leading-snug text-slate-500">
            ...
            <div className={containersShippingRowClass}>
              ...
              <div className="grid min-h-0 grid-cols-1 gap-1.5 sm:grid-cols-2 sm:items-stretch">
                <section className={flushSectionClass} aria-label="Sample">
                  <div className={cn(flushSectionBodyClass, sectionStackClass, "overflow-y-auto")}>
                    <FormRow
                      label={
                        sampleRowCount > 0 ? (
