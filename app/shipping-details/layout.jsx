import { ShippingDetailsBubbleNav } from "@/components/shipping-details-bubble-nav";

export default function ShippingDetailsLayout({ children }) {
  return (
