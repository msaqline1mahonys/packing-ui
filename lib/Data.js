    ...
    importPermitFiles: [
      {
        ...
        name: "Ahbab Faiyaz - SC482 visa - Tax Invoice (2).pdf",
        type: "application/pdf",
        url: "/demo-pack-attachments/tax-invoice-sc482.pdf",
      },
    ],
    rfpFiles: [
      {
        ...
        name: "Glowbird.pdf",
        type: "application/pdf",
        url: "/demo-pack-attachments/glowbird.pdf",
      },
    ],
    packingInstructionFiles: [
      {
        id: "demo-10442-ecr",
        name: "ECR-example.pdf",
        type: "application/pdf",
        url: "/demo-pack-attachments/ecr-example.pdf",
      },
    ],
    additionalDeclarationFiles: [
      {
        id: "demo-10442-gppir",
        name: "GPPIR-example.pdf",
        type: "application/pdf",
        url: "/demo-pack-attachments/gppir-example.pdf",
      },
    ],
