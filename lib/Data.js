...
export const FUMIGANT_MASTER_ROWS = [
  {
    id: 1,
    code: "PH3",
    name: "Phosphine",
...
export const CONTACT_USER_ROWS = [
  {
    ...
    aoExpiry: "2026-12-31",
    aoNumber: "00022",
    userClassifications: ["AUTHORISED_OFFICER", "FUMIGATOR", "PACKER", "WEIGHBRIDGE"],
...
export const GENERAL_PACK_PRICING_STATE = {
  defaultPackingPrices: [
    { id: 1, commodityTypeId: 1, containerSize: "20FT", price: 95, rateBasis: "perTon" },
    { id: 2, commodityTypeId: 2, containerSize: "20FT", price: 102.5, rateBasis: "perTon" },
  ],
  commodityPrices: [{ id: 1, commodityId: 1, containerSize: "20FT", price: 99, rateBasis: "perTon" }],
  commodityTypeCustomerPrices: [
    { id: 1, customerId: 1, commodityTypeId: 1, containerSize: "20FT", price: 91.25, rateBasis: "perTon" },
  ],
  commodityCustomerPrices: [{ id: 1, customerId: 1, commodityId: 1, containerSize: "20FT", price: 88.75, rateBasis: "perTon" }],
};

export const GENERAL_FUMIGANT_PRICING_STATE = {
  baseFumigantPrices: [{ id: 1, fumigantId: 1, price: 34.5 }],
  customerFumigantPrices: [{ id: 1, customerId: 1, fumigantId: 1, price: 31.25 }],
};

export const GENERAL_TRANSPORT_PRICE_ROWS = [
  { id: 1, transporterId: 1, containerSize: "20ft", lineItemDescription: "Standard 20ft Transport", price: 150.00 },
  { id: 2, transporterId: 1, containerSize: "40ft", lineItemDescription: "Standard 40ft Transport", price: 250.00 },
  { id: 3, transporterId: 2, containerSize: "20ft", lineItemDescription: "Express 20ft Transport", price: 180.00 },
];
...
export const PACK_TEMPLATE = {
  ...
  status: "Pending",
  jobReference: "",
  // Treatment provider & compliance identifiers
  treatmentProviderId: "",
  fumigatorAccreditationNumber: "",
  // Consignment context for gov-template
  terminalId: "",                  // FK -> REFERENCE_TERMINAL_ROWS; pre-fills portOfLoading
  portOfLoading: "",
  ...
  fumigationDetail: {
    ...
    fumigationType: "ambient",             // "ambient" | "controlled"
    // Target & enclosure (gov template)
    targetOfFumigation: ["commodity"],    // ["commodity","container","packaging"] — commodity selected by default
    enclosureType: "",                    // "sheeted"|"chamber"|"unsheeted-container"|"other"
    enclosureOtherText: "",
    ...
    consignmentSuitable: true,            // true | false | null — defaults to suitable
    ...
    actualTemperature: "",
    // Prescribed treatment (from methodology — user-editable on cert)
    prescribedDoseRate: "",
    ...
    actualDosageAppliedValue: "",         // Amount CH3Br applied (g)
    actualDosageAppliedUnit: "g",
    // MBR-specific
    chloropicrinUsed: null,               // true | false | null (MBR only)
    chloropicrinPercent: "",
    heatersUsed: null,                    // true | false | null (MBR only)
    // SF end-point + CT (Section 10.2 SF methodology); harmless for MBR
    endPointConcentration: "",            // g/m3 — final concentration at end of exposure
    endPointConcentrationUnit: "g/m3",
    ctRequired: "",                       // g·h/m3 — prescribed CT (3rd-party approved systems)
    ctAchieved: "",                       // g·h/m3 — actual CT integral achieved
    thirdPartySystem: false,              // approved 3rd-party CT system used?
    ...
    monitoringDeviceSerials: "",          // free text, comma-separated
    finalTlvPpm1: "",
    finalTlvPpm2: "",
    finalTlvPpm3: "",
    clearanceValue: "",
    // Top-up entries (array)
    topUpEntries: [],                     // [{id, amountGm3, time, concentrationGm3}]
    // Personnel
    fumigatorName: "",
    // Result & supervision
    fumigationResult: "pass",             // "pass" | "fail" — pass by default
  ...
  rfpPackType: "",
  rfpTotalQuantity: "",
  rfpQuantityUnit: "M/TONS",
  rfpFlowPath: "Packaged",
  originalRfpNumber: "",
...
export const PACK_SCHEDULE_ROWS = [
  {
    ...
    importPermitNumber: "DAFF-VN-2026-88921",
    importPermitDate: "2026-04-28",
    importPermitFiles: [
      {
        id: "demo-10442-permit",
        name: "Export Booking Confirmation - S00199571.PDF",
        type: "application/pdf",
        url: "/demo-pack-attachments/export-booking-confirmation-s00199571.pdf",
      },
    ],
    rfpFiles: [
      {
        id: "demo-10442-rfp",
        name: "RFP_C0265866-4_10775544_PackerCopy.pdf",
        type: "application/pdf",
        url: "/demo-pack-attachments/rfp-c0265866-4-packer-copy.pdf",
      },
    ],
    packingInstructionFiles: [
      {
        id: "demo-10442-ecr",
        name: "C0265866-4_PACKING_INSTRUCTIONS.pdf",
        type: "application/pdf",
        url: "/demo-pack-attachments/c0265866-4-packing-instructions.pdf",
      },
    ],
    additionalDeclarationFiles: [
      {
        id: "demo-10442-gppir",
        name: "L0946784 - 35mt CAN1 Delivered Mahonys - Wc 8.5.pdf",
        type: "application/pdf",
        url: "/demo-pack-attachments/l0946784-35mt-can1-delivered-mahonys-wc-85.pdf",
      },
    ],
...
export const REFERENCE_CONTAINER_CODE_ROWS = [
  {
    id: 1,
    isoCode: "22G1",
    containerSize: "20FT",
...
export const APP_DATA = {
  ...
  accounting: {
    ...
    generalFumigantPricing: GENERAL_FUMIGANT_PRICING_STATE,
  ...
  referenceData: {
    ...
    containerCodes: REFERENCE_CONTAINER_CODE_ROWS,
