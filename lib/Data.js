...
export const SAMPLE_STATUSES = ["Pending", "Sent", "Passed", "Failed"];
export const ALL_SAMPLE_STATUSES = [...SAMPLE_STATUSES, "Cancelled"];

export const PACK_FORM_LOOKUPS = {
  // All lookup lists (customers, commodities, shippingLines, containerParks,
  // transporters, packers, sites, terminals, vesselVoyages) are now API-sourced
  // via GET /api/packing/packs/form-data. Only the CSV import demo rows remain here.
...
export const PACK_TEMPLATE = {
  ...
  daffInspectionBooked: null,
  daffConfirmedDate: "",
  unloadingLocation: "",
  importDirectionsReceived: null,
  importDirectionCode: "",
  edoReceived: null,
  dateCollected: "",
  freeDays: "",
  ...
  importPackNotes: "",
  importOrderFiles: [],
  importPackingListFiles: [],
  importAdditionalFiles: [],
  importContainerListFiles: [],
};
...
export const REFERENCE_SHIPPING_LINE_ROWS = [
  {
    ...
    shippingLineContacts: [
      {
        contactName: "Schedules Desk",
        contactEmail: "schedules@example.com",
        contactPhone: "+61 3 9000 1111",
      },
    ],
    shippingLineContactsSummary: "1 contact",
  },
];
