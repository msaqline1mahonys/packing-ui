...
export function resolveFumigationCertificate(packId, packOverride = null) {
  ...
  const rawDetail = pack.fumigationDetail ?? pack.fumigation_detail;
  ...
  return {
    ...
    fumigatorAccreditationNumber: blank(pack.fumigatorAccreditationNumber ?? pack.fumigator_accreditation_number),
    ...
    commodityQuantity: blank(fd.actualTonnage || (pack.mtTotal ?? pack.mt_total)),
