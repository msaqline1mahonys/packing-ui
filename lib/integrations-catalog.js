...
export const INBOUND_INTEGRATIONS = [
  {
    ...
    summary:
      "Receive carrier VS (schedule) and VR (rotation) CSV files to create and update vessel departures.",
    method: "POST",
    ...
    fileFields: [
      {
        ...
        multipart: "vs_file",
        json: "vs_csv",
        description: "Creates and updates vessels and voyages.",
      },
      {
        key: "vr",
        ...
        multipart: "vr_file",
        json: "vr_csv",
        description: "Enriches terminal names and updates terminals on existing voyages.",
      },
    ],
    standardHeaders: [
