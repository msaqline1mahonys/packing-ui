...
/** Pack statuses where packer signoff and out-load/in-load triggers are not allowed. */
export const PACKERS_SIGNOFF_BLOCKED_STATUSES = ["Pending", "On Hold"];
...
export function isPackersPackerSignoffBlocked(packStatus) {
  return PACKERS_SIGNOFF_BLOCKED_STATUSES.includes(packStatus);
}
