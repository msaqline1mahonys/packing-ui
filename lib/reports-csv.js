...
const CONTAINER_COLUMNS = [
  ...
  { key: "status", label: "Status" },
  { key: "replacesContainerNumber", label: "Replaces Container" },
  { key: "replacedByContainerNumber", label: "Replaced By" },
...
const PACK_COLUMNS = [
  ...
  { key: "availableToPackContainers", label: "Available to Pack" },
