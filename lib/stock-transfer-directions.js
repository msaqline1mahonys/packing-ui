...
export const DIRECTION_FIELD_RULES = {
  ...
  mixin: {
    description: "Blend commodity grades into a mixed stock position.",
    fields: {
      datetime: { required: true },
      siteId: { required: false },
      locationId: { required: true },
      amount: { required: true, sign: "positive" },
      stockOwnerId: { required: true },
      sourceCommodityId: { required: true, label: "Source Commodity Grade" },
      commodityId: { required: true, label: "Result Commodity Grade" },
      notes: { required: false },
    },
  },
  mixout: {
    ...
    fields: {
      ...
      amount: { required: true, sign: "negative" },
      stockOwnerId: { required: true },
      sourceCommodityId: { required: true, label: "Mixed Commodity Grade" },
      commodityId: { required: true, label: "Extracted Commodity Grade" },
      notes: { required: false },
    },
  },
};
